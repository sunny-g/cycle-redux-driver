...
describe('makeReduxDriver', () => {
  ...
  describe('state source', () => {
    ...
    test.skip('should emit a single `null` if no arguments are passed into `makeReduxDriver`', (done) => {});

    test.skip('should emit new state if watched action is emitted', (done) => {});

    test.skip('should not emit new state if non-watched actions are emitted', (done) => {});
